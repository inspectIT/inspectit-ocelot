 ...
 * For example a {@link VariableAccessor} for "_arg3" is guaranteed to return the method cal larguemtn with index 3 in the context of the current method call.
 * If the variable does no begin with an underscore, it is fetched from the {@link rocks.inspectit.ocelot.bootstrap.exposed.InspectitContext}.
 */
@FunctionalInterface
