...
/**
 * {@link ICommonAttributesProvider} that provides the environment based tags like service name, host, etc.
 * <p>
...
@Component
@Slf4j
public class EnvironmentAttributesProvider implements ICommonAttributesProvider {
