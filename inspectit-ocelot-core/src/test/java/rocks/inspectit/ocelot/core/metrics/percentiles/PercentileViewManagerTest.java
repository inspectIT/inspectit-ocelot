...
public class PercentileViewManagerTest {
    ...
    @BeforeEach
    void init() {
        viewManager = new PercentileViewManager();
        viewManager.init();
    }
