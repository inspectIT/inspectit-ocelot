...
@DirtiesContext
class PropagationSessionStorageTest extends SpringTestBase {

    @Autowired
    PropagationSessionStorage sessionStorage;

    static final String validSessionID = "test=83311527d6a6de76a60a72a041808a63;b0b2b4cf=ad9fef38-4942-453a-9243-7d8422803604";

    static final String anotherValidSessionID = "test=83311527d6a";

    static final String shortSessionID = "test-session";
