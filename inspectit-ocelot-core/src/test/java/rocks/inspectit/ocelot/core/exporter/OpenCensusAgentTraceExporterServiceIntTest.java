...
public class OpenCensusAgentTraceExporterServiceIntTest extends SpringTestBase {
    ...
    public void testGrpcRequest() {
        ...
        await().atMost(15, TimeUnit.SECONDS).untilAsserted(() -> {
            assertThat(fakeOcAgentTraceServiceGrpc.getExportTraceServiceRequests()).anySatisfy((req) -> assertThat(req.getSpansList())
                    .anySatisfy((span) -> assertThat(span.getName().getValue()).isEqualTo(SPAN_NAME)));
        });
    }
