...
public class PercentileViewTest {
    ...
    class GetSeriesNames {
        ...
        void checkPercentileSeries() {
            PercentileView view = new PercentileView(false, false, ImmutableSet.of(0.5), Collections.emptySet(), 10, "name", "unit", "description", 1);
        ...
        @Test
        void checkMinSeries() {
            PercentileView view = new PercentileView(true, false, Collections.emptySet(), Collections.emptySet(), 10, "name", "unit", "description", 1);
        ...
        @Test
        void checkMaxSeries() {
            PercentileView view = new PercentileView(false, true, Collections.emptySet(), Collections.emptySet(), 10, "name", "unit", "description", 1);
        ...
        void checkAllPercentileSeries() {
            PercentileView view = new PercentileView(true, true, ImmutableSet.of(0.5), Collections.emptySet(), 10, "name", "unit", "description", 1);
    ...
    class ComputeMetrics {
        ...
        void checkQuantileMetricDescriptor() {
            PercentileView view = new PercentileView(false, false, ImmutableSet.of(0.5), ImmutableSet.of("my_tag"), 10, "name", "unit", "description", 1);
        ...
        void checkMinMetricDescriptor() {
            PercentileView view = new PercentileView(true, false, Collections.emptySet(), ImmutableSet.of("my_tag"), 10, "name", "unit", "description", 1);
        ...
        void checkMaxMetricDescriptor() {
            PercentileView view = new PercentileView(false, true, Collections.emptySet(), ImmutableSet.of("my_tag"), 10, "name", "unit", "description", 1);
        ...
        void checkMinimumMetric() {
            PercentileView view = new PercentileView(true, false, Collections.emptySet(), ImmutableSet.of("my_tag"), 10, "name", "unit", "description", 4);
        ...
        void checkMaximumMetric() {
            PercentileView view = new PercentileView(false, true, Collections.emptySet(), ImmutableSet.of("my_tag"), 10, "name", "unit", "description", 4);
        ...
        void checkPercentileMetrics() {
            PercentileView view = new PercentileView(false, false, ImmutableSet.of(0.5, 0.9), ImmutableSet.of("my_tag"), 10, "name", "unit", "description", 18);
