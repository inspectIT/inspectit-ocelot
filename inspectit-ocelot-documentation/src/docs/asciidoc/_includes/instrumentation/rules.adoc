...
The conditions that can be defined are equal to the ones of data providers, thus, please see the <<Adding Conditions, action conditions description>> for detailed information.