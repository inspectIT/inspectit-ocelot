...
a| image::demo-landscape-influxdb-zipkin.png[link=https://openapm.io/landscape?agent=inspectit-ocelot-agent&instrumentation-lib=opencensus&collector=influx-telegraf,zipkin-server&storage=influx-db&dashboarding=grafana]
...
a| image::demo-landscape-prometheus-jaeger.png[link=https://openapm.io/landscape?agent=inspectit-ocelot-agent&instrumentation-lib=opencensus&collector=prometheus-server,jaeger-collector&dashboarding=grafana&visualization=jaeger-query]
...
image::demo-landscape-influxdb-zipkin.png[link=https://openapm.io/landscape?agent=inspectit-ocelot-agent&instrumentation-lib=opencensus&collector=influx-telegraf,zipkin-server&storage=influx-db&dashboarding=grafana]
...
image::demo-landscape-prometheus-jaeger.png[link=https://openapm.io/landscape?agent=inspectit-ocelot-agent&instrumentation-lib=opencensus&collector=prometheus-server,jaeger-collector&dashboarding=grafana&visualization=jaeger-query]
