---
id: version-1.16.0-installation
title: Installation
...
```bash
$ java -javaagent:"/path/to/inspectit-ocelot-agent-1.16.0.jar" -jar my-java-program.jar
```
...
```bash
$ java -jar inspectit-ocelot-agent-1.16.0.jar <PID> [<AGENT_ARGUMENTS>]
```
...
```bash
$ ./jattach.sh <PID> load instrument false /path/to/inspectit-ocelot-agent-1.16.0.jar='{"inspectit.service-name" : "MyService"}'
```
