...
public class FileController extends FileBaseController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "query", value = "The query string that should be searched in the files."), @ApiImplicitParam(name = "limit", value = "The limit for the returned values. Use '-1' for no limit."), @ApiImplicitParam(name = "retrieveFirstLine", value = "If true, the first line of each match is added to the search results.")})
