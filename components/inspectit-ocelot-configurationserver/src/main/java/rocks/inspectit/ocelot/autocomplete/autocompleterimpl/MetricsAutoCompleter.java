...
public class MetricsAutoCompleter implements AutoCompleter {
     ...
     */
    private static final List<List<String>> RULE_SUGGESTION_PATHS = Arrays.asList(METRICS_DECLARATION_PATH, Arrays.asList("inspectit", "instrumentation", "rules", "*", "metrics"), Arrays
            .asList("inspectit", "instrumentation", "rules", "*", "metrics", "*", "metric"));
