...
class AgentMappingControllerTest {
    ...
    class GetMappings {
        ...
        @Test
        void successfullyGetAgentMappings() {
    ...
    class PutMappings {
        ...
        @Test
        void successfullyPutMappings() throws IOException {
            List<AgentMapping> dummyList = new ArrayList<>();
    ...
    @Nested
    class GetMappingByName {

        @Test
        void successfullyGetMappingByName() {
    ...
    @Nested
    class DeleteMappingByName {

        @Test
        void successfullyDeleteMappingByName() throws IOException {
        ...
        @Test
        void mappingNotFound() throws IOException {
    ...
    class PutMapping {
        ...
        @Test
        void successfullyPutMapping() throws IOException {
        ...
        @Test
        void addMappingBefore() throws IOException {
        ...
        @Test
        void addMappingAfter() throws IOException {
