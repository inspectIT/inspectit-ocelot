...
public class ConfigurationFilesCacheTest {
    ...
    public class LoadYaml {
        ...
        public void testLoadYaml() throws IOException {
            ...
            expected.put("i am a", list);

            LinkedHashMap output = (LinkedHashMap) configurationFilesCache.loadYaml(testPath);
        ...
        public void fileManagerReturnsNull() throws IOException {
            ...
            Object output = configurationFilesCache.loadYaml(testPath);
    ...
    public class GetYamlContents {
        ...
        public void testYamlLoadingMap() throws IOException {
            ...
            doReturn(Arrays.asList("a", "b")).when(spyConfigurationFilesCache).getAllPaths();
            List<String> list = Arrays.asList("test", "yaml");
