  ...
  render() {
    return (
      <div style={{ marginTop: '0.25em', display: 'flex' }}>
        ...
        `}</style>
        <div className="left">
          <SourceToolbar sourcePaths={this.props.sources} onChange={this.handleChangeSources} />
          <SourceTable
        ...
        <div className="right">
          <SourceTree sourcePaths={this.props.sources} onSelectionChange={this.handleChangeSources} visible={this.props.visible} />
        </div>
      </div>
    );
  }
