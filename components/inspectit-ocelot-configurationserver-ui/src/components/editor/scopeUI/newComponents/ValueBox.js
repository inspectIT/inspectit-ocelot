...
class ValueBox extends React.Component {
  ...
  render() {
    ...
    return (
        <div  ref={this.componentBorderRef}  style={{display: 'inline-flex', width:'100%', marginBottom: '15px', position:'relative', background: 'white', padding: '10px 30px 0px 10px', borderRadius:'10px'}}>
