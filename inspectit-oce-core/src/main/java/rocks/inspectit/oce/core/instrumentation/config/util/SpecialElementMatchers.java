...
public class SpecialElementMatchers {
     ...
     */
    public static <T extends MethodDescription> ElementMatcher.Junction<T> argumentsAre(String[] arguments) {
        if (arguments == null) {
            return null;
     ...
     */
    public static <T extends ModifierReviewable.OfByteCodeElement> ElementMatcher.Junction<T> visibilityIs(AccessModifier[] modifiers) {
        if (modifiers == null) {
            return null;
        }
