...
public interface SpecialSensor {
     ...
     * If this method returns true, {@link #instrument(TypeDescription, InstrumentationSettings, DynamicType.Builder)}
     ...
     * <p>
     * It is guaranteed that this method is only invoked if {@link #shouldInstrument(TypeDescription, InstrumentationSettings)}
     ...
     * This method is guaranteed to be only invoked when {@link #shouldInstrument(TypeDescription, InstrumentationSettings)} for the same parameters returns true.
     *
     ...
     */
    DynamicType.Builder instrument(Class<?> clazz, TypeDescription type, InstrumentationSettings settings, DynamicType.Builder builder);
