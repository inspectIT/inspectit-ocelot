...
public class LogCorrelationTest {
    ...
    private static void beforeAll() throws InterruptedException {
        ...
        TestUtils.waitForClassInstrumentations(Arrays.asList(LogCorrelationTest.class, Thread.class, AbstractExecutorService.class, ScheduledThreadPoolExecutor.class), 15, TimeUnit.SECONDS);
    }
